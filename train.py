...
def train(hyp, opt, device, callbacks):
    ...
    if pretrained:
        ...
        model = Model(cfg or ckpt["model"].yaml, ch=3, nc=nc, anchors=hyp.get("anchors"), mode='training').to(device)  # create
        ...
        model = Model(cfg, ch=3, nc=nc, anchors=hyp.get("anchors"), mode='training').to(device)  # create
